            ...
            judgeIsChange: function (e) {
                ...
                if (this.tempArr.length >= 1)
                    if (this.playerNode.typeID <= e) {
                        this.playerNode.typeID+=1, this.playerNode.typeID > this.maxTypeID && (this.maxTypeID = this.playerNode.typeID);
                    ...
                    } else this.playerNode.typeID > e && this.tempArr.length >= 2 && this.EatSmallAction2()
            },
